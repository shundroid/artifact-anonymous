module {
  handshake.func @resolver_lhs(%actual: !handshake.channel<i1>, %generated: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>) attributes {argNames = ["Actual", "Generated"], resNames = ["Confirm"]} {
    ...
    %actual_ri = ee__repeating_init %actual_buf2 {handshake.bb = 1 : ui32, handshake.name = "ri"} : <i1>
    %confirm = ee__interpolator %actual_ri, %generated {handshake.bb = 1 : ui32, handshake.name = "interpolator"} : <i1>
