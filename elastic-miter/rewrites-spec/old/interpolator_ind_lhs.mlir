module {
  handshake.func @interpolator_ind_lhs(%a: !handshake.channel<i1>, %b: !handshake.channel<i1>, %sup_in: !handshake.channel<i1>, ...) -> (!handshake.channel<i1>) attributes {argNames = ["A_in", "B_in", "Sup_in"], resNames = ["Sup_out"]} {
    ...
    %interpolate = ee__interpolator %a, %b_forked#0 {handshake.bb = 1 : ui32, handshake.name = "interpolate"} : <i1>
    %ri = ee__repeating_init %b_forked#1 {handshake.bb = 1 : ui32, handshake.name = "ri", initToken = 1 : ui1} : <i1>
