...
# python3 experimental/tools/integration/run_EE_integration.py fixed_log --n 0 --disable-initial-motion --out out_baseline_merged_5ns --cp 5.00
python3 experimental/tools/integration/run_EE_integration.py fixed_log --n 0 --disable-initial-motion --out out_baseline_merged_7ns --cp 7.00
