...
struct PostEEPass
    : public dynamatic::experimental::EE::impl::PostEEBase<PostEEPass> {
  using PostEEBase<PostEEPass>::PostEEBase;
...
void PostEEPass::runDynamaticPass() {
