...
#define GEN_PASS_DEF_EECUTCONDDEP
...
struct EECutCondDepPass
    : public dynamatic::experimental::EE::impl::EECutCondDepBase<
          EECutCondDepPass> {
  using EECutCondDepBase<EECutCondDepPass>::EECutCondDepBase;
  void runDynamaticPass() override;
};

void EECutCondDepPass::runDynamaticPass() {
