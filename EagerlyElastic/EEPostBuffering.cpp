...
#define GEN_PASS_DEF_EEPOSTBUFFERING
...
struct EEPostBufferingPass
    : public dynamatic::experimental::EE::impl::EEPostBufferingBase<
          EEPostBufferingPass> {
  using EEPostBufferingBase<EEPostBufferingPass>::EEPostBufferingBase;
  void runDynamaticPass() override;
};

void EEPostBufferingPass::runDynamaticPass() {
